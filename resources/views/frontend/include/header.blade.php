...
{{--                            <span class="icon-bar"></span>--}}
{{--                        </button>--}}
                        <div class="row navbar_top">
                            <div class="col-md-6">
                                <a class="navbar-brand" href="{{url('/')}}"><img src="{{asset('assets/images/tuba_logo_GIF.gif')}}" class="dp_logo" alt="ft-logo"></a>
                            </div>
                            <div class="col-md-6 text-right login_register">
                                <a href="">Login</a>
                                /
                                <a href="">Register</a>
                            </div>
