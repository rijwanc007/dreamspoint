                    ...
                    <div class="collapse navbar-collapse" id="cat-nav-mega">
                        <ul class="nav navbar-nav">
                            <li class="dropdown menu-large active">
                                <a href="{{route('frontend.men.cloth')}}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">MEN <i class="fa fa-angle-down"></i></a>
...
{{--                                                                </div>--}}
        ...
        <br/>
        <div class="row">
            {!! Form::open(['route' => 'men.search','method' => 'GET']) !!}
            <div class="col-md-4">
            ...
            {!! Form::close() !!}
            {!! Form::open(['route' => 'men.price.search','method' => 'GET']) !!}
            <div class="col-md-2">
